...
from components.navigation.side_bar_list_element import SidebarListElement
...
class SidebarComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.logout_list_item = SidebarListElement(page, 'logout')
        self.courses_list_item = SidebarListElement(page, 'courses')
        self.dashboard_list_item = SidebarListElement(page, 'dashboard')
